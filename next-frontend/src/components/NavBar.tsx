...
const NavBar = ()=>{
    return (
        <aside className="w-1/4 bg-card p-6 sticky top-0">
      <div className="text-center mb-4">
        <Image src="/images/profile.jpg" height={60} width={60} alt="Profile Picture" className="w-24 h-24 mx-auto mb-2 object-cover object-center" />
        <h3 className="text-lg font-bold">Sayantan</h3>
        <p className={sharedClasses.mutedForeground}>Passionate Web Designer</p>
      </div>
      <nav>
        <ul>
          <li>
